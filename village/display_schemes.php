...
<h2 class="mb-3 text-center">Available Schemes</h2>
    ...
    <tbody>
        ...
        if ($result && $result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                if (!empty($document)) {
                    echo "<a href='{$document}' target='_blank' class='btn btn-primary btn-sm me-1'>View PDF</a>";
                    echo "<a href='{$document}' download class='btn btn-success btn-sm'>Download</a>";
                } else {
            ...
            echo "<tr><td colspan='4' class='text-center'>No schemes available</td></tr>";
        }
        ?>
