...
<section class="checkout">
    ...
    <div class="flex">
        <div class="inputBox">
            ...
            pattern="[A-Za-z ]{3,50}" 
            title="Name should contain only letters (3-50 characters)" 
            required>
        </div>
        <div class="inputBox">
<span>your number :</span>
    ...
    required>
        ...
        <div class="inputBox">
            ...
            pattern="[A-Za-z ]{2,50}" 
            title="City should contain only letters" required>
        </div>
        <div class="inputBox">
            <span>state :</span>
            <input type="text" name="state" placeholder="e.g. maharashtra" 
            pattern="[A-Za-z ]{2,50}" 
            title="State should contain only letters" required>
        </div>
        <div class="inputBox">
            <span>country :</span>
            <input type="text" name="country" placeholder="e.g. india" 
            pattern="[A-Za-z ]{2,50}" 
            title="Country should contain only letters" required>
        </div>
        <div class="inputBox">
            <span>pin code :</span>
            <input type="number" min="100000" max="999999" name="pin_code" 
